(function() {
  ...
  _.last = function(array, n) {
    return n === undefined ? array[array.length - 1] : n > array.length - 1 ? array.slice(0, n) : array.slice(array.length - n);
  };
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(passedTest, item) {
      ...
      return iterator === undefined ? item : iterator(item) ? true : false;
    }, true);
  };
  ...
  _.delay = function(func, wait) {
    var convertedArguments = Array.prototype.slice.call(arguments);
    var actualArgs = convertedArguments.slice(2, convertedArguments.length);
    setTimeout(function() {
  ...
  _.shuffle = function(array) {
    ...
    var lengthOfOriginalArray = copyOfArray.length;
    var outputArray = [];
    for (var i = 0; i < lengthOfOriginalArray; i++) {
      var currentLengthOfArray = copyOfArray.length;
      var randomElement = copyOfArray[Math.floor(Math.random() * currentLengthOfArray)];
      outputArray.push(randomElement);
      var indexOfRandomElement = _.indexOf(copyOfArray, randomElement);
      copyOfArray.splice(indexOfRandomElement, 1);
    }
    return outputArray;
  };
